package ru.ermakov.creator.feature.shared;
...
public final class ParamNameConstants {
    ...
    public static final String PROFILE_AVATAR_URL_COLUMN = "profile_avatar_url";
    public static final String PROFILE_BACKGROUND_URL_COLUMN = "profile_background_url";
    ...
    public static final String IS_EVERYTHING_PARAM = "is_everything";
    public static final String IS_ONLY_ALLOWED_PARAM = "is_only_allowed";
